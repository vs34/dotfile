...
For developers: Copyfish is published under an open-source (GPL) license. As OCR software, Copyfish uses the free OCR API on https://ocr.space/ and (for local OCR) the UI.Vision RPA XModule OCR https://ui.vision .
