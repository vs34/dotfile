...
function updateHourlyrateValue() {
  ...
  timeWorthTable.append(
    "<tr><th>The average number of hours saved a month using SwiftRead*:</th><td>" +
      hoursPerMonth.toFixed(2) +
      "</td></tr>"
  );
  ...
  timeWorthTable.append(
    '<tr class="border-top"><th>Monthly amount saved using SwiftRead:</th><td><span class="big">$' +
      worth.toFixed(2) +
  ...
  timeWorthTable.append(
    "<tr><td><small>* if you haven't used SwiftRead for more than a month, this number is an extrapolation. Based on national average reading speed of 200 WPM.</small></td></tr>"
  );
}
...
$(document).ready(function () {
  ...
  $("#reading-test-button").on("click", function (e) {
    e.preventDefault();
    chrome.tabs.create(
...
function initStatistics() {
  ...
  statisticsTable.append(
    "<tr><th>Time saved by using SwiftRead: </th><td>" +
      timeSavedString +
      "</td></tr>"
  );
  ...
  //average wpm
  statisticsTable.append(
    "<tr><th>Your average reading speed: </th><td>" +
      Math.round(averageWpm).toString() +
      " WPM</td></tr>"
  );
  ...
  statisticsTable.append(
    "<tr><th>Total time spent: </th><td>" + totalTimeSpentString + "</td></tr>"
  );

  //total words read
  statisticsTable.append(
    "<tr><th>Total words read: </th><td>" +
      wordCount.toString() +
      " words</td></tr>"
  );
