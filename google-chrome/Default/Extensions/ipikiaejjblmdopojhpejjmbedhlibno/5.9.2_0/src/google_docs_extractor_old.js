...
function extractCurrentPage() {
	...
	chrome.runtime.sendMessage({ action: "storeLocationString", locationString: gdocsLocationString }, function (response) {
	...
	// TODO: import mixpanel into google docs extractor and track event correctly. "Extract Text", { source: "Google Doc"}
