  ...
  "handle": {
    ...
    "store": function (e) {
      ...
      if (id.startsWith("--native-dark-")) {
        ...
        let tmp = {};
        const cond_1 = id === "nativerangelimitmin" || id === "nativerangelimitmax";
        const cond_2 = id === "nativerangethresholdmin" || id === "nativerangethresholdmax";
        const cond_3 = id === "custom" || id === "nativecssrules" || id === "scheduleon" || id === "scheduleoff";
        /*  */
        tmp[id] = cond_1 || cond_2 || cond_3 ? e.target.value : e.target.checked;
        /*  */
